...
public class ApodoxiAporipsiAstheni extends javax.swing.JFrame {

    
    public ApodoxiAporipsiAstheni() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Αποδεικτικό Αρχείο ΑΜΚΑ:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApodoxiAporipsiAstheni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApodoxiAporipsiAstheni().setVisible(true);
            }
        });
    }
