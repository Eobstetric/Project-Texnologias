 ...
 * @author 7_USER
 */
public class RegisterPageAstheni extends javax.swing.JFrame {

    /**
     * Creates new form RegisterPageAstheni
     */
    public RegisterPageAstheni() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Κωδικός Ξανά");

        jLabel9.setText("Αποδεικτικό Αρχείο");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterPageAstheni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterPageAstheni().setVisible(true);
            }
        });
    }
