...
public class HomePageAstheni extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("ΤΑ ΡΑΝΤΕΒΟΥ ΜΟΥ");
        ...
        jButton2.setText("ΟΙ ΤΟΚΕΤΟΙ ΜΟΥ");

        jButton3.setText("ΕΠΕΞΕΡΓΑΣΙΑ ΛΟΓΑΡΙΑΣΜΟΥ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomePageAstheni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomePageAstheni().setVisible(true);
            }
        });
    }
