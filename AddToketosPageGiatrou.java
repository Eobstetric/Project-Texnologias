...
public class AddToketosPageGiatrou extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Προσθήκη Τοκετού");

        jLabel2.setText("Επιλέξτε Ημερομηνία:");
        ...
        jLabel3.setText("Επιλέξτε Ώρα:");

        jLabel4.setText("Εισάγετε ΑΜΚΑ Ασθενή:");

        jLabel5.setText("Επιλέξτε Αίθουσα:");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddToketosPageGiatrou().setVisible(true);
            }
        });
    }
